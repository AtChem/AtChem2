...
def convert(input_file, mech_dir, mcm_dir):
    ...
    with open(os.path.join(mech_dir, 'mechanism.f90'), 'w') as mech_rates_file:
        mech_rates_file.write("""! Note that this file is generated by tools/build/mech_converter.py based upon the file mcm/mechanism_test.fac
! Any manual edits to this file will be overwritten when calling tools/build/mech_converter.py
""")
...
""")
    ...
    with open(os.path.join(mech_dir, 'mechanism.ro2'), 'w') as ro2_file:
        ro2_file.write("""! Note that this file is generated by tools/build/mech_converter.py based upon the file mcm/mechanism_test.fac Any manual edits to this file will be overwritten when calling tools/build/mech_converter.py
""")
