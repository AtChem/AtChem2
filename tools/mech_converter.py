...
""")
    ...
    with open(os.path.join(script_directory, '../modelConfiguration/mechanism-rate-declarations.f90'), 'w') as mr3_file:
...
""")
    ...
    with open(os.path.join(input_directory, 'mechanism-rate-coefficients.ftemp'), 'r') as mech_rates_temp_file, \
        open(os.path.join(input_directory, 'mechanism-rate-coefficients.f90'), 'a') as mech_rates_coeff_file:
