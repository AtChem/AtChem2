...
application. \textbf{AtChem2} was developed from AtChem-online with
the objective to provide an \emph{offline} modelling tool capable of
...
comprehensive Testsuite and version control software
...
according to their setup, workflow, personal preferences, etc\ldots
As long as the user specifies the correct paths to the libraries and
