...
TESTS := short single_reac_of_interest short_extended spec_yes_plus_fixed_env_no spec_no_env_yes1 spec_no_env_yes2 spec_yes_env_no spec_yes_env_no_with_photo spec_yes_env_no_with_jfac spec_yes_env_yes full
