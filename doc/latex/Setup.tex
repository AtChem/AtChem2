...
radicals~\footnote{The hydroperoxyl radical (\cf{HO2}) is a peroxy
  ...
  \emph{should not} be included in the \cf{RO2} sum.} and that all the
...
with the notation \verb|J<i>| -- where \texttt{i} is the ID number
...
The paths and names of these directories can be modified by the user,
