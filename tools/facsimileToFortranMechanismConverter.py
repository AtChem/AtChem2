...
assert os.path.isfile(os.path.join(input_directory, input_filename)), 'The input file ' + str(os.path.join(input_directory, input_filename)) + ' does not exist.'
...
with open(os.path.join(input_directory, 'mechanism.reactemp'), 'w') as reac_temp_file, open(os.path.join(input_directory, 'mechanism.prod'), 'w') as prod_file:
...
# the first line).
with open(os.path.join(input_directory, 'mechanism.reactemp')) as reac_temp_file, open(os.path.join(input_directory, 'mechanism.reac'), 'w') as reac_file:
...
with open(os.path.join(input_directory, 'mechanism-rate-coefficients.f90'), 'w') as mech_rates_file:
...
""")
    ...
    with open(os.path.join(input_directory, 'mechanism-rate-coefficients.ftemp')) as mech_rates_temp_file:
...
! Note that this file is generated by tools/facsimileToFortranMechanismConverter.py,
! based upon the file tools/mcm_subset.fac. Any manual edits to this file will be overwritten
! when calling tools/facsimileToFortranMechanismConverter.py
