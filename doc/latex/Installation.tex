...
gnuplot, Octave~\footnote{GNU Octave is an open source implementation
  of MATLAB. The script \texttt{plot-atchem2.m} should work with both
  Octave and MATLAB}, Python (v2 and v3), and R. One or more of these
...
\textit{N.B.}: whenever the \texttt{model/} directory is mentioned in
