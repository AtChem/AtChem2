...
Note that the hydroperoxyl radical (\cf{HO2}) is a peroxy radical but
...
rate. AtChem2 outputs the value of the \cf{RO2} sum to the
...
column, with one species per line.  %% TODO: how to change the number
...
the \cf{RO2} sum, which are always output separately
(Sect.~\ref{sec:output}).
